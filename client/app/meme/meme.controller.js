...
.controller('MemeCtrl', function (ImageGenerator, $scope) {
  ...
  $scope.backgroundImgs = [
    ['/assets/meme-generator/bg-01.jpg', 'Image 1'],
    ['/assets/meme-generator/bg-02.jpg', 'Image 2'],
    ['/assets/meme-generator/bg-03.jpg', 'Image 3'],
    ['/assets/meme-generator/bg-04.jpg', 'Image 4'],
    ['/assets/meme-generator/bg-05.jpg', 'Image 5'],
    ['/assets/meme-generator/bg-06.jpg', 'Image 6'],
    ['/assets/meme-generator/bg-07.jpg', 'Image 7'],
    ['/assets/meme-generator/bg-08.jpg', 'Image 8'],
    ['/assets/meme-generator/bg-09.jpg', 'Image 9'],
    ['/assets/meme-generator/bg-10.jpg', 'Image 10'],
    ['/assets/meme-generator/bg-11.jpg', 'Image 11'],
    ['/assets/meme-generator/bg-12.jpg', 'Image 12'],
    ['/assets/meme-generator/bg-13.jpg', 'Image 13'],
    ['/assets/meme-generator/bg-14.jpg', 'Image 14'],
    ['/assets/meme-generator/tile-1.png', 'Tile 1'],
    ['/assets/meme-generator/tile-2.png', 'Tile 2'],
    ['/assets/meme-generator/tile-3.png', 'Tile 3']
  ];
