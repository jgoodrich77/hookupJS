...
fmt('    -p <int>            number of results per page (default: %d)', cfgKwQuery.pageSize),
    '    -d|--date=<str>     fetch data for keywords that have not been fetched since before this date.',
    '    -i|--import         import keywords that are not in the database already (otherwise they will be skipped)',
